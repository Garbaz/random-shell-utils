...
xsetwacom set "$padname" Button 11 'key +ctrl +shift z -shift -ctrl'
xsetwacom set "$padname" Button 12 'key +ctrl z -ctrl'
xsetwacom set "$padname" Button 13 'key f'
xsetwacom set "$padname" Button 14 'key b'
xsetwacom set "$padname" Button 15 'key x'
#xsetwacom set "$padname" Button 16 'key e'
xsetwacom set "$padname" Button 16 'key +ctrl +alt 2 -ctrl -alt'
